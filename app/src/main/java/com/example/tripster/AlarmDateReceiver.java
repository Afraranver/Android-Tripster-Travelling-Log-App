...
public class AlarmDateReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context k1, Intent k2) {
        ...
        builder.setContentText("Event Day!!");
...
//        builder.addAction (R.drawable.ic_baseline_alarm_on_24,"tst", dismissIntent);
